...
export const metadata: Metadata = {
  title: "IT Home - Quality IT Education & Career Training",  description: "Master in-demand tech skills with IT Home. Comprehensive IT courses with 94% job placement rate. Enroll in web development, data science, and programming programs.",  keywords: "IT school, web development course, data science training, programming education, tech career",  robots: {
    index: true,
    follow: true
  },
  openGraph: {
    title: "IT Home - Quality IT Education & Career Training",    description: "Master in-demand tech skills with IT Home. Comprehensive IT courses with 94% job placement rate.",    type: "website",    siteName: "IT Home"
  },
  twitter: {
    card: "summary_large_image",    title: "IT Home - Quality IT Education & Career Training",    description: "Master in-demand tech skills with industry experts. Start your tech career today."
  }
};
...
export default function RootLayout({
  ...
  return (
    <html lang="en" suppressHydrationWarning>
      <ServiceWrapper>
        <body
          className={`${workSans.variable} ${sourceSans3.variable} antialiased`}
        >
          <Tag />
          {children}
